        ...
        <div className="bg-gray-200">
          <div className="container mx-auto py-6 px-5 md:px-24 flex flex-wrap flex-col sm:flex-row max-w-screen-lg">
            <p className="text-gray-500 text-sm text-center sm:text-left">
              <a href="/" className="text-gray-600 ml-1" target="_blank">© 2020 NOT SO BAD, LLC.</a>
            </p>
            <span className="inline-flex sm:ml-auto sm:mt-0 mt-2 justify-center sm:justify-start">
              <a href='https://twitter.com/kame_f_no7' target='_blank' rel="noopener noreferrer" className="ml-3 text-gray-500">
